...
const CARD_DB = {
    "Strike": { type: "Attack", cost: 1, val: 6, desc: "Deal 6 damage.", img: "assets/cards/strike.png" },
    "Defend": { type: "Skill", cost: 1, block: 5, desc: "Gain 5 Block.", img: "assets/cards/defend.png" },
    "Bash": { type: "Attack", cost: 2, val: 8, vul: 2, desc: "Deal 8 dmg. Apply 2 Vulnerable.", img: "assets/cards/bash.png" },
    "Neutralize": { type: "Attack", cost: 0, val: 3, weak: 1, desc: "Deal 3 dmg. Apply 1 Weak.", img: "assets/cards/neutralize.png" },
    "Survivor": { type: "Skill", cost: 1, block: 8, discard: 1, desc: "Gain 8 Block. Discard 1 card.", img: "assets/cards/survivor.png" },
    "Eruption": { type: "Attack", cost: 2, val: 9, wrath: true, desc: "Deal 9 dmg. Enter Wrath.", img: "assets/cards/eruption.png" },
    "Vigilance": { type: "Skill", cost: 2, block: 8, calm: true, desc: "Gain 8 Block. Enter Calm.", img: "assets/cards/vigilance.png" },
    "Cleave": { type: "Attack", cost: 1, val: 8, desc: "Deal 8 damage to ALL enemies (Targeting TBD).", img: "assets/cards/cleave.png" },
    "Pommel Strike": { type: "Attack", cost: 1, val: 9, draw: 1, desc: "Deal 9 dmg. Draw 1 card.", img: "assets/cards/pommel-strike.png" },
    "Shrug It Off": { type: "Skill", cost: 1, block: 8, draw: 1, desc: "Gain 8 Block. Draw 1 card.", img: "assets/cards/shrug-it-off.png" },
    "Deadly Poison": { type: "Skill", cost: 1, poison: 5, desc: "Apply 5 Poison.", img: "assets/cards/deadly-poison.png" },
    "Blade Dance": { type: "Skill", cost: 1, shivs: 2, desc: "Add 2 Shivs to hand.", img: "assets/cards/blade-dance.png" },
    "Shiv": { type: "Attack", cost: 0, val: 4, exhaust: true, desc: "Deal 4 damage. Exhaust.", img: "assets/cards/shiv.png" },

    // --- IRONCLAD EXPANSION ---
    "Iron Wave": { type: "Attack", cost: 1, val: 5, block: 5, desc: "Deal 5 damage. Gain 5 Block.", img: "assets/cards/iron-wave.png" },
    "Clothesline": { type: "Attack", cost: 2, val: 12, weak: 2, desc: "Deal 12 damage. Apply 2 Weak.", img: "assets/cards/clothesline.png" },
    "Thunderclap": { type: "Attack", cost: 1, val: 4, vul: 1, desc: "Deal 4 damage. Apply 1 Vulnerable.", img: "assets/cards/thunderclap.png" },
    "Twin Strike": { type: "Attack", cost: 1, val: 10, desc: "Deal 10 damage.", img: "assets/cards/twin-strike.png" },
    "Sword Boomerang": { type: "Attack", cost: 1, val: 9, desc: "Deal 9 damage.", img: "assets/cards/sword-boomerang.png" },
    "Inflame": { type: "Power", cost: 1, strength_gain: 2, desc: "Gain 2 Strength.", img: "assets/cards/inflame.png" },
    "Spot Weakness": { type: "Skill", cost: 1, strength_gain: 3, desc: "Gain 3 Strength.", img: "assets/cards/spot-weakness.png" },
    "Reaper": { type: "Attack", cost: 2, val: 4, heal: 4, desc: "Deal 4 damage. Heal 4 HP.", img: "assets/cards/reaper.png" },
    "Flame Barrier": { type: "Skill", cost: 2, block: 12, desc: "Gain 12 Block.", img: "assets/cards/flame-barrier.png" },
    "Uppercut": { type: "Attack", cost: 2, val: 13, weak: 1, vul: 1, desc: "Deal 13 dmg. Apply 1 Weak, 1 Vuln.", img: "assets/cards/uppercut.png" },

    // --- SILENT EXPANSION ---
    "Dagger Spray": { type: "Attack", cost: 1, val: 4, desc: "Deal 4 damage.", img: "assets/cards/dagger-spray.png" },
    "Dagger Throw": { type: "Attack", cost: 1, val: 9, draw: 1, desc: "Deal 9 damage. Draw 1 card.", img: "assets/cards/dagger-throw.png" },
    "Poisoned Stab": { type: "Attack", cost: 1, val: 6, poison: 3, desc: "Deal 6 dmg. Apply 3 Poison.", img: "assets/cards/poisoned-stab.png" },
    "Sucker Punch": { type: "Attack", cost: 1, val: 7, weak: 1, desc: "Deal 7 damage. Apply 1 Weak.", img: "assets/cards/sucker-punch.png" },
    "Backflip": { type: "Skill", cost: 1, block: 5, draw: 2, desc: "Gain 5 Block. Draw 2 cards.", img: "assets/cards/backflip.png" },
    "Footwork": { type: "Power", cost: 1, dexterity_gain: 2, desc: "Gain 2 Dexterity.", img: "assets/cards/footwork.png" },
    "Leg Sweep": { type: "Skill", cost: 2, block: 11, weak: 2, desc: "Gain 11 Block. Apply 2 Weak.", img: "assets/cards/leg-sweep.png" },
    "Crippling Cloud": { type: "Skill", cost: 2, poison: 3, weak: 2, desc: "Apply 3 Poison and 2 Weak.", img: "assets/cards/crippling-cloud.png" },
    "Bouncing Flask": { type: "Skill", cost: 2, poison: 9, desc: "Apply 9 Poison.", img: "assets/cards/bouncing-flask.png" },
    "Adrenaline": { type: "Skill", cost: 0, energy_gain: 1, draw: 2, exhaust: true, desc: "Gain 1 Energy. Draw 2. Exhaust.", img: "assets/cards/adrenaline.png" }
};
